...
function submitRobotForm() {
    ...
    postData.push(escape(settingsName + '.diffDistanceToAllign') + '=' + param3Val); 
    postData.push(escape(settingsName + '.minDistanceToFullWashAngle') + '=' + param4Val); 
    postData.push(escape(settingsName + '.distanceToResetSWLimitOfWM') + '=' + param5Val); 
    postData.push(escape(settingsName + '.correctFrontDistance') + '=' + param6Val); 
    postData.push(escape(settingsName + '.maxRobotSteps') + '=' + param7Val); 
    postData.push(escape(settingsName + '.setManualWashVelocity') + '=' + param8Val); 
    postData.push(escape(settingsName + '.numWashesBeforeStart') + '=' + param9Val);
    postData.push(escape(settingsName + '.numWashesAtTheEnd') + '=' + param10Val);
    postData.push(escape(settingsName + '.leftSWLimit') + '=' + param11Val); 
    postData.push(escape(settingsName + '.rightSWLimit') + '=' + param12Val); 
    postData.push(escape(settingsName + '.setRobotVelocity') + '=' + param13Val); 
